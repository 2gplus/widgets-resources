    ...
    return new Promise((resolve, reject) => {
        ...
        if (window.device.platform === "iOS") {
            if (window.plugins && window.plugins.touchid) {
                window.plugins.touchid.verifyFingerprint(reason, () => {
                    resolve(true);
                }, () => {
                    resolve(false);
                });
                ...
                reject(new Error("BiometricAuthentication action requires cordova-plugin-touch-id to be installed in the iOS app"));
            }
        }
            ...
            if (window.FingerprintAuth) {
                ...
                reject(new Error("BiometricAuthentication action requires cordova-plugin-android-fingerprint-auth to be installed in the Android app"));
            }
        }
    });
    // END USER CODE
