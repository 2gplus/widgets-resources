...
export function Gallery(props: GalleryContainerProps): ReactElement {
    ...
    const isInfiniteLoad = props.pagination === "virtualScrolling" || props.pagination === "virtualScrollingVert";
    ...
    return (
        <GalleryComponent
            ...
            desktopItemsDynamic={props.desktopItemsDynamic}
            ...
            phoneItemsDynamic={props.phoneItemsDynamic}
            setPage={setPage}
            tabletItems={props.tabletItems}
            tabletItemsDynamic={props.tabletItemsDynamic}
            tabIndex={props.tabIndex}
            verticalScroll={props.pagination === "virtualScrollingVert"}
        />
    );
}
